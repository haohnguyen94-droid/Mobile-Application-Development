...
import 'package:user_authenication/ui/add_note_screen.dart';
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          // Signs the current user out; AuthGate's authStateChanges stream
          // reacts and routes back to the sign-in screen.
          IconButton(
